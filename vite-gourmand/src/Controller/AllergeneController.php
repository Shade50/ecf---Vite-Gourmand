...
final class AllergeneController extends AbstractController
{
    ...
    #[Route('admin/allergene/new', name: 'app_allergene_new', methods: ['GET', 'POST'])]
    ...
    #[Route('admin/allergene/{id}', name: 'app_allergene_show', methods: ['GET'])]
    ...
    #[Route('admin/allergene/{id}/edit', name: 'app_allergene_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('admin/allergene/{id}', name: 'app_allergene_delete', methods: ['POST'])]
