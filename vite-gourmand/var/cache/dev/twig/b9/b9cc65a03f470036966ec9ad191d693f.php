...
class __TwigTemplate_c97d1f558f0ef523fc64178c7f2ec2b1 extends Template
{
...
(isset($context["token"]) || array_key_exists("token", $context) ? $context["token"] : (function () { throw new RuntimeError('Variable "token" does not exist.', 9, $this->source); })())]), "profiler_markup_version" => 3]);
    ...
    ";
        ...
        if (array_key_exists("excluded_ajax_paths", $context)) {
            ...
            // line 306
            yield (string) json_encode((isset($context["excluded_ajax_paths"]) || array_key_exists("excluded_ajax_paths", $context) ? $context["excluded_ajax_paths"] : (function () { throw new RuntimeError('Variable "excluded_ajax_paths" does not exist.', 306, $this->source); })()));
            yield "))) {
                            var stackElement = {
                                error: false,
                                url: url,
            ...
            // line 368
            yield (string) json_encode((isset($context["excluded_ajax_paths"]) || array_key_exists("excluded_ajax_paths", $context) ? $context["excluded_ajax_paths"] : (function () { throw new RuntimeError('Variable "excluded_ajax_paths" does not exist.', 368, $this->source); })()));
            yield "))) {
        ...
        // line 687
        yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["token"]) || array_key_exists("token", $context) ? $context["token"] : (function () { throw new RuntimeError('Variable "token" does not exist.', 687, $this->source); })()), "html", null, true);
        yield "\x27);
    /*]]>*/</script>
</div>
...
";
    ...
    {
        return array (  784 => 687,  752 => 658,  661 => 570,  538 => 449,  506 => 420,  500 => 417,  496 => 416,  490 => 413,  486 => 412,  439 => 368,  374 => 306,  368 => 302,  366 => 301,  76 => 19,  65 => 14,  60 => 11,  58 => 9,  57 => 4,  53 => 3,  49 => 1,);
    }
...
<!-- END of Symfony Web Debug Toolbar -->
", "@WebProfiler/Profiler/toolbar_js.html.twig", "D:\\Pulsecrea\\mes dev purebasic\\ecf - Vite&Gourmand\\vite-gourmand\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Profiler\\toolbar_js.html.twig");
    }
}
