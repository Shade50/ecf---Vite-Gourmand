...
class __TwigTemplate_8a16104a2fd76f92fa8b42120f5b376a extends Template
{
        ...
        ";
            ...
            ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["transport"]) {
                    ...
                    <b>";
                    // line 20
                    yield (string) (((($tmp = $context["transport"]) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($context["transport"], "html", null, true)) : ("<em>Empty Transport Name</em>"));
                    yield "</b>
                    <span class=\"sf-toolbar-status\">";
                    // line 21
...
";
    ...
    <span class=\"label ";
        // line 70
        yield (string) (((($tmp = Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, (isset($context["events"]) || array_key_exists("events", $context) ? $context["events"] : (function () { throw new RuntimeError('Variable "events" does not exist.', 70, $this->source); })()), "messages", [], "any", false, false, false, 70))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("") : ("disabled"));
        yield "\">
        <span class=\"icon\">";
        // line 71
        yield (string) Twig\Extension\CoreExtension::source($this->env, "@WebProfiler/Icon/notifier.svg");
        ...
        if ((Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, (isset($context["events"]) || array_key_exists("events", $context) ? $context["events"] : (function () { throw new RuntimeError('Variable "events" does not exist.', 74, $this->source); })()), "messages", [], "any", false, false, false, 74)) > 0)) {
            ...
            yield "            <span class=\"count\">
                <span>";
            // line 76
            yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, (isset($context["events"]) || array_key_exists("events", $context) ? $context["events"] : (function () { throw new RuntimeError('Variable "events" does not exist.', 76, $this->source); })()), "messages", [], "any", false, false, false, 76)), "html", null, true);
            yield "</span>
            </span>
        ";
        }
...
";
    ...
    ";
        ...
        <div class=\"card-block\">
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["event"]) {
                ...
                // line 110
                yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["loop"], "index", [], "any", false, false, false, 110), "html", null, true);
                yield " <small>(";
                yield (string) (((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["event"], "isQueued", [], "method", false, false, false, 110)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("queued") : ("sent"));
                yield ")</small></h3>
                        <div class=\"tab-content\">
                            <div class=\"card\">
                                <div class=\"card-block\">
                                    ...
                                    <h2 class=\"m-t-10\">";
                // line 115
                yield (string) (((CoreExtension::getAttribute($this->env, $this->source, ($context["message"] ?? null), "getSubject", [], "method", true, true, false, 115) &&  !(null === CoreExtension::getAttribute($this->env, $this->source, (isset($context["message"]) || array_key_exists("message", $context) ? $context["message"] : (function () { throw new RuntimeError('Variable "message" does not exist.', 115, $this->source); })()), "getSubject", [], "method", false, false, false, 115)))) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["message"]) || array_key_exists("message", $context) ? $context["message"] : (function () { throw new RuntimeError('Variable "message" does not exist.', 115, $this->source); })()), "getSubject", [], "method", false, false, false, 115), "html", null, true)) : ("(empty)"));
                yield "</h2>
                                </div>
                                ";
                // line 117
                ...
                if ((($tmp = (isset($context["notification"]) || array_key_exists("notification", $context) ? $context["notification"] : (function () { throw new RuntimeError('Variable "notification" does not exist.', 132, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    ...
                    yield "<br/>";
                    // line 141
                    yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(("Exception: " . (((CoreExtension::getAttribute($this->env, $this->source, ($context["notification"] ?? null), "getException", [], "method", true, true, false, 141) &&  !(null === CoreExtension::getAttribute($this->env, $this->source, (isset($context["notification"]) || array_key_exists("notification", $context) ? $context["notification"] : (function () { throw new RuntimeError('Variable "notification" does not exist.', 141, $this->source); })()), "getException", [], "method", false, false, false, 141)))) ? (CoreExtension::getAttribute($this->env, $this->source, (isset($context["notification"]) || array_key_exists("notification", $context) ? $context["notification"] : (function () { throw new RuntimeError('Variable "notification" does not exist.', 141, $this->source); })()), "getException", [], "method", false, false, false, 141)) : ("(empty)"))), "html", null, true);
                    yield "<br/>";
                    // line 142
                ...
                if ((null === CoreExtension::getAttribute($this->env, $this->source, (isset($context["message"]) || array_key_exists("message", $context) ? $context["message"] : (function () { throw new RuntimeError('Variable "message" does not exist.', 151, $this->source); })()), "getOptions", [], "method", false, false, false, 151))) {
                    ...
                    // line 154
                    yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(json_encode(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["message"]) || array_key_exists("message", $context) ? $context["message"] : (function () { throw new RuntimeError('Variable "message" does not exist.', 154, $this->source); })()), "getOptions", [], "method", false, false, false, 154), "toArray", [], "method", false, false, false, 154), Twig\Extension\CoreExtension::constant("JSON_PRETTY_PRINT")), "html", null, true);
                }
                // line 156
                yield "                                                        </pre>
                                                    </div>
    ...
    {
        return array (  473 => 165,  450 => 156,  447 => 154,  444 => 152,  442 => 151,  437 => 147,  429 => 142,  426 => 141,  423 => 140,  420 => 139,  417 => 138,  414 => 137,  409 => 133,  407 => 132,  403 => 130,  395 => 125,  390 => 123,  384 => 119,  381 => 118,  379 => 117,  374 => 115,  364 => 110,  361 => 109,  358 => 108,  341 => 107,  333 => 103,  329 => 102,  325 => 100,  315 => 97,  311 => 96,  308 => 95,  304 => 94,  300 => 92,  294 => 88,  292 => 87,  287 => 84,  284 => 83,  271 => 82,  259 => 79,  253 => 76,  250 => 75,  248 => 74,  242 => 71,  238 => 70,  235 => 69,  232 => 68,  219 => 67,  172 => 31,  159 => 30,  145 => 26,  142 => 25,  138 => 24,  128 => 21,  124 => 20,  121 => 19,  117 => 18,  111 => 15,  107 => 13,  105 => 12,  102 => 11,  96 => 9,  91 => 8,  88 => 7,  86 => 6,  83 => 5,  80 => 4,  67 => 3,  44 => 1,);
    }
...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@WebProfiler/Collector/notifier.html.twig", "D:\\Pulsecrea\\mes dev purebasic\\ecf - Vite&Gourmand\\vite-gourmand\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\notifier.html.twig");
    }
}
