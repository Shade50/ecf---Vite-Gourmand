 ...
 */
final class Version20260709084846 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE menu (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(150) NOT NULL, description LONGTEXT NOT NULL, minimum_person INT NOT NULL, price NUMERIC(10, 2) NOT NULL, conditions LONGTEXT DEFAULT NULL, stock INT NOT NULL, image VARCHAR(255) DEFAULT NULL, theme_id INT NOT NULL, INDEX IDX_7D053A9359027487 (theme_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
